...
INSERT INTO `management_hotel`.`room` (`id_room`, `nameroom`, `num_bed`, `description`, `price`, `admin_id`) VALUES ('H202', 'Phòng cặp đôi vip 1', '1', 'View bờ biển đón ánh bình minh', '250000', '1');
INSERT INTO `management_hotel`.`room` (`id_room`, `nameroom`, `num_bed`, `description`, `price`, `admin_id`) VALUES ('H301', 'Phòng gia đình vip 1', '2', 'View bờ biển đón ánh bình minh cho cả nhà', '800000', '1');
